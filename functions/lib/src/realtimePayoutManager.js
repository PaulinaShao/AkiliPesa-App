...
exports.realtimePayoutManager = functions.firestore
    ...
    let reason = "";
    // 1️⃣ Completed sale
    if (collectionId === "sales" && after.status === "completed" && (before === null || before === void 0 ? void 0 : before.status) !== "completed") {
        targetUid = after.agentId || after.sellerId;
        amount = after.amount || 0;
        reason = "Completed Sale Payout";
    }
    // 2️⃣ Escrow release
    if (collectionId === "escrow" && (before === null || before === void 0 ? void 0 : before.status) !== "released" && after.status === "released") {
