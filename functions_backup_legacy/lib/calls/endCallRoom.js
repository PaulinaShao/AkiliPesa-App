 ...
 */
exports.endCallRoom = (0, https_1.onCall)(async (request) => {
    ...
    if (data.hostId !== uid) {
        throw new https_1.HttpsError("permission-denied", "Only host can end the call.");
    }
    await roomRef.set({
        status: "ended",
        endReason: reason,
...
//# sourceMappingURL=endCallRoom.js.map