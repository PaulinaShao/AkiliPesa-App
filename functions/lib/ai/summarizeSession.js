...
export const summarizeAiSession = onCall({ region: "us-central1", secrets: [OPENAI_API_KEY] }, async (request) => {
    ...
    if (transcriptSnap.empty) {
        throw new HttpsError("failed-precondition", "No transcripts found for this call.");
    }
