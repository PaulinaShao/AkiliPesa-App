...
exports.buildWalletNotifications = buildWalletNotifications;
 ...
 */
function buildWalletNotifications(uid, before, after) {
    const notifications = [];
    if (!after)
        return notifications;
    const beforeWallet = (before || {});
    const afterWallet = (after || {});
    ...
    if (newBalance === 0 && prevBalance > 0) {
        ...
        notifications.push({
            ...
            body: `Your wallet is below TZS ${LOW_BALANCE_THRESHOLD.toLocaleString("en-US")}. Please top up.`,
            channels: { inApp: true, push: true, email: false },
        });
    }
...
//# sourceMappingURL=onWalletUpdated.js.map