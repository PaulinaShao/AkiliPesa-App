...
import { enforceTransactionUid } from "./enforceTransactionUid.js";
import { realtimePayoutManager } from "./realtimePayoutManager.js";
import { onVoiceUpload } from "./openvoiceTrigger.js";
admin.initializeApp();
...
export const getAgoraToken = functions.https.onCall(async (data, context) => {
    ...
    const token = RtcTokenBuilder.buildTokenWithUid(appId, appCert, channelName, 0, role, expire);
    // Log call session
